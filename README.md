...
| Route                 | Function                                               |
| --------------------- | ------------------------------------------------------ |
| `/home/*`             | 중처법 카테고리·중대재해 유형별 의무 집계·검색·목록    |
...
상단 GNB에는 `홈`을 `적용범위 판정` 왼쪽에 추가했습니다. 홈 LNB는 **중처법 카테고리별**과 **중대재해 유형별** 두 구역으로 구성하며, 클라이언트 의무풀 3,688건만 집계합니다. 중대산업재해는 제4조·제5조 의무 14건, 중대시민재해는 승인된 분류에 따라 공중이용시설·공중교통수단 13건과 원료·제조물 9건으로 표시합니다. 관계법령 관리조치는 하위 그룹 확정 전 단계이므로 법령 드롭다운과 검색을 제공합니다.
