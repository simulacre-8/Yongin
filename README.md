...
> 프로젝트 인수자는 먼저 [`HANDOVER.md`](HANDOVER.md)를 확인하십시오. GitHub ZIP 다운로드, 최종 사이트 이용, 로컬 실행, 기존 Supabase·Netlify 인수 방법을 한 문서에 정리했습니다.
...
- `HANDOVER.md`: GitHub ZIP 다운로드부터 사이트·DB·배포 인수까지의 최종 사용법
- `docs/deliverables/ADOMS_용인시_업무명세_V1_상세.html`: 클라이언트용 상세 업무명세
